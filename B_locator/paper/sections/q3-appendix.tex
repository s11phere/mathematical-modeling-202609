...
逐组结果与完整动作记录分别存于 \path{Q3/results/} 和 \path{Q3/results/traces/}；
正文图、完整补充图册分别为 \path{Q3/figures/} 和 \path{Q3/supplement.pdf}。
运行环境与已完成核验见 \path{Q3/README.md}，论文数字及图表的证据对应见
\path{Q3/DATA_SOURCES.md}。各程序均通过 \path{Q3/reproduce.py} 调用。
...
\lstinputlisting[language=python,caption={问题三最终 \textrm{joint} 策略核心代码}]{../attachments/Q3/code/p3_joint.py}
