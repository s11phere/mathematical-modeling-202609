...
SCENARIO_DESCRIPTIONS = {
    "mixed_uniform": "10–16 sources; position uniform in area in the 1800 m disk; each source directional with probability 0.5; directional bearing uniform on [0, 360); reception radius uniform on [1000, 1500] m.",
    "minrange": "10–16 sources; position uniform in disk area; all directional, uniform bearings; reception radius exactly 1000 m.",
    "edge": "10–16 sources; radial coordinate uniform on [1750, 1800] m and polar angle uniform; all directional with station-to-source bearing set to polar angle + 180 degrees; reception radius 1000 m, so sources can be heard only from their outside half-plane.",
    "omni": "10–16 sources; position uniform in disk area; all omnidirectional; reception radius uniform on [1000, 1500] m.",
}
